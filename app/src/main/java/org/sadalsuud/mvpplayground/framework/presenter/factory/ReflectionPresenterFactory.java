 ...
 */
public class ReflectionPresenterFactory<P extends MvpPresenter> implements PresenterFactory<P> {
     ...
     */
    @Nullable
    public static <P extends MvpPresenter> ReflectionPresenterFactory<P> fromViewClass(Class<?> viewClass) {
